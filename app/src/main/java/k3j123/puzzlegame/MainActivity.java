...
public class MainActivity extends AppCompatActivity {
    ...
    public void onImageFromCameraClick(View view) {
        ...
        if (intent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photioUri = FileProvider.getUriForFile(this, getApplicationContext().getPackageName() + ".fileprovider", photoFile);
                intent.putExtra(MediaStore.EXTRA_OUTPUT, photioUri);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE && resultCode == RESULT_OK) {
            ...
            intent.putExtra("mCurrentPhotoPath", currentPhotoPath);
            startActivity(intent);
        }
